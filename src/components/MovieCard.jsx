...
export default function MovieCard({ entry, onClick, onStatusChange }) {
...
export function MovieDetail({ entry, onClose, onUpdate, onRemove }) {
  const { movie, status, rating, review, addedAt } = entry;
  const st = STATUS_MAP[status];
      ...
      <div className="modal detail-modal">
        ...
        <div className="detail-body">
          ...
          <div className="detail-section detail-footer">
            <span className="detail-added">添加于 {new Date(addedAt).toLocaleDateString('zh-CN')}</span>
